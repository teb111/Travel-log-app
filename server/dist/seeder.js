...
var importData = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, Country_1.default.deleteMany()];
            case 2:
                _a.sent();
                return [4 /*yield*/, User_1.default.insertMany(users_1.default)];
            case 3:
                createdUsers = _a.sent();
                return [4 /*yield*/, Country_1.default.insertMany(countries_1.default)];
            case 4:
                _a.sent();
